...
const quoteCitation = document.querySelector('#quoteCitation');
...
quoteAuthor.innerHTML = quotes[number].source;
quote.innerHTML = quotes[number].quote;
quoteCitation.innerHTML = quotes[number].citation;
quoteYear.innerHTML = quotes[number].year;
quoteTag.innerHTML = quotes[number].tags;
